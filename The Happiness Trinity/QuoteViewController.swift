...
class QuoteViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        let randomQuote = quotesArray.randomElement()
